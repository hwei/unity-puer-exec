...
- `T1.4.1` is complete; the next major CLI step is to establish a product-owned baseline that implements the newly documented formal contract.
...
- Use `T1.4.2` to establish a product-owned CLI baseline that follows `docs/decisions/0007-formal-cli-contract.md`.
