...
- [ ] 3.1 Compare the new validation evidence against earlier Prompt B style runs and decide whether default `log_offset` still needs further exploration.
- [ ] 3.2 Prepare archive-readiness notes summarizing whether the example-first change was sufficient on its own.
