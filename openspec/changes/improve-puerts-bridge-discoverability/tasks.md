...
- [ ] 3.1 Define how future validation should measure faster bridge recognition without conflating it with compile recovery or persistence confirmation
- [ ] 3.2 Record the follow-up implementation targets, if any, only after the exploration output is clear
